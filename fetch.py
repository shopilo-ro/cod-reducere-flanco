#!/usr/bin/env python3
"""
Fetch coduri de reducere Flanco de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/flanco.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/flanco.ro"
STORE_NAME = "Flanco"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Flanco de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-flanco)"
    }
    try:
